...
const operationsCards = []
    ...
    .concat(duplicate(new OperationsCard({ name: 'Stadium Tours', cost: 3, income: 3}), 7))
    .concat(duplicate(new OperationsCard({ name: 'Cafe', cost: 3, income: 2, draw: 1}), 7))        
...
const strategyCards = []
    ...
    .concat(duplicate(new RescindSuspensionStrategyCard({cost: 3}), 2))
    ...
    .concat(duplicate(new PlayerTypeBonusStrategyCard({cost: 5, name: 'Shooting Training', description: 'Shooters', attribute: 'Shooter', bonus: 2}), 2))
    .concat(duplicate(new PlayerTypeBonusStrategyCard({cost: 5, name: 'Defending Training', description: 'Defenders', attribute: 'Defender', bonus: 2}), 1))
    .concat(duplicate(new PlayerTypeBonusStrategyCard({cost: 6, name: 'Scoring Training', description: 'Scorers', attribute: 'Scorer', bonus: 2}), 2))
    .concat(duplicate(new PlayerTypeBonusStrategyCard({cost: 5, name: 'Rebounding Training', description: 'Rebounders', attribute: 'Rebounder', bonus: 2}), 1))
    .concat(duplicate(new PlayerTypeBonusStrategyCard({cost: 4, name: 'Passing Training', description: 'Passers', attribute: 'Passer', bonus: 2}), 1))
    .concat(duplicate(new PlayerTypeBonusStrategyCard({cost: 5, name: 'Youth Coach', description: 'Rookies', attribute: 'Rookie', bonus: 2}), 2))
    .concat(duplicate(new PlayerTypeBonusStrategyCard({cost: 3, name: 'Clutch Time', description: 'Clutch', attribute: 'Clutch', bonus: 2}), 1))
    .concat(duplicate(new SinglePlayerTypeBonusStrategyCard({cost: 2, name: 'Glory Days', description: '1 Veteran', attribute: 'Veteran', bonus: 2}), 2))    
    .concat(duplicate(new SinglePlayerTypeBonusStrategyCard({cost: 4, name: 'Shooting 1 on 1', description: '1 Shooter', attribute: 'Shooter', bonus: 2}), 2))
    .concat(duplicate(new SinglePlayerTypeBonusStrategyCard({cost: 3, name: 'Defending 1 on 1', description: '1 Defender', attribute: 'Defender', bonus: 2}), 2))
    .concat(duplicate(new SinglePlayerTypeBonusStrategyCard({cost: 4, name: 'Scoring 1 on 1', description: '1 Scorer', attribute: 'Scorer', bonus: 2}), 2))
    .concat(duplicate(new SinglePlayerTypeBonusStrategyCard({cost: 3, name: 'Rebounding 1 on 1', description: '1 Rebounder', attribute: 'Rebounder', bonus: 2}), 1))
    .concat(duplicate(new SinglePlayerTypeBonusStrategyCard({cost: 3, name: 'Passing 1 on 1', description: '1 Passer', attribute: 'Passer', bonus: 2}), 2))          
...
const playerCards = [
    ...
    new PlayerCard({name: 'Victor Oladipo', cost: 7, ability: 7, positions: ['SG', 'PG'], attributes: ['Defender', 'Shooter'], boosts: [], boosters: [], chemistry: 2}),
    ...
    new PlayerCard({name: 'Devon Booker', cost: 5, ability: 5, positions: ['SG', 'PG'], attributes: ['Scorer'], boosts: [], boosters: [], chemistry: 1}),
    ...
    new PlayerCard({name: 'Paul George', cost: 7, ability: 7, positions: ['SF', 'SG'], attributes: ['Defender', 'Shooter'], boosts: [], boosters: [], chemistry: 3}),
    new PlayerCard({name: 'Luka Doncic', cost: 6, ability: 6, positions: ['SF', 'PG'], attributes: ['Rookie', 'Scorer'], boosts: [], boosters: [], chemistry: 1}),    
    new PlayerCard({name: 'Andrew Wiggins', cost: 6, ability: 6, positions: ['SF', 'SG'], attributes: ['Scorer'], boosts: [{requires: 'Shooter', ability: 1}], boosters: [], description: "Gains +1 ability if playing with a Shooter", chemistry: 4}),
    ...
    new PlayerCard({name: 'Kris Middleton', cost: 5, ability: 5, positions: ['SF', 'SG'], attributes: [], boosts: [{requires: 'Passer', attribute: 'Scorer'}], boosters: [], description: "Gains Scorer attribute if playing with a Passer", chemistry: 2}),
    ...
    new PlayerCard({name: 'Brandom Ingram', cost: 4, ability: 4, positions: ['SF', 'PF'], attributes: [], boosts: [], boosters: [], chemistry: 3}),    
    ...
    new PlayerCard({name: 'Carmelo Anthony', cost: 3, ability: 3, positions: ['SF', 'PF'], attributes: ['Veteran', 'Clutch'], boosts: [{requires: 'Passer', attribute: 'Shooter'}], boosters: [], description: "Gains Shooter attribute if playing with a Passer", chemistry: 5}),
    ...
    new PlayerCard({name: 'Julius Randle', cost: 4, ability: 4, positions: ['PF', 'C'], attributes: ['Rebounder'], boosts: [], boosters: [], chemistry: 3}),    
    ...
    new PlayerCard({name: 'Dirk Nowitzki', cost: 3, ability: 3, positions: ['PF', 'C'], attributes: ['Veteran', 'Shooter', 'Rebounder'], boosts: [], boosters: [{attribute: 'Rookie', ability: 1}], description: "All Rookies get +1 ability", chemistry: 4}),
    ...
    new PlayerCard({name: 'Karl Anthony Towns', cost: 6, ability: 6, positions: ['C', 'PF'], attributes: ['Scorer'], boosts: [], boosters: [], chemistry: 4}),    
    ...
    new PlayerCard({name: 'Al Horford', cost: 5, ability: 5, positions: ['C', 'PF'], attributes: [], boosts: [], boosters: [], chemistry: 2}),
...
const freeAgentCards = duplicate(new PlayerCard({name: 'Free Agent', cost: 2, ability: 2, positions: null}), 8);
